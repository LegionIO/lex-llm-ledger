      ...
      module Ledger
        module Runners
          module Tools
            ...
            def write_tool_record(payload = nil, metadata = {}, **message)
              ...
              db.transaction do
                ...
                if tool_call_row && !new_tool_call
                  ...
                  find_or_create_tool_call_attempt(db, tool_call_row, tool, body, props, headers)
                end
              end
            ...
            # Find or create the llm_tool_calls row.
            # Returns [row, inserted] where inserted=true when a new row was written.
            def find_or_create_tool_call(db, response, body, ctx, tool, headers)
            ...
            # Find or create the llm_tool_call_attempts row.
            def find_or_create_tool_call_attempt(db, tool_call_row, tool, body, props, headers) # rubocop:disable Metrics/CyclomaticComplexity
